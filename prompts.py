...
The focus of your analisys should be on what the data is, how it is formatted, what each column stands for,
and how new data should be added."""
...
3. how new data should look like, based on the patterns you're identified
"""
...
Use the exact formatting as the original data. Output only generated rows, no extra text.
DOT NOT INCLUDE ANY TEXT BEFORE/AFTER THE DATA. JUST START BY OUTPUTTING THE NEW ROWS. NO EXTRA TEXT!!!"""